             ...
             <ul class="countdown-{{ $shop->product_token }}" id="countdown-timer">
                                         ...
                                         @if($shop->product_type != 'digital')
                                           <span>
                                              ...
                                              <input type="number" name="qty" class="form-control qty_box" data-bvalidator="required,min[1],max[{{ $shop->product_stock }}]" value="1">
                                           </span>
                                          @else
                                          ...
                                          @endif 
                                           ...
                                           <span>
                                              ...
                                              <select name="product_attribute[]" class="form-control qty_box">
                                                 ...
                                                 <option value="{{ $product_value->attribute_value_id }}_{{ $attribute->attribute_name }} - {{ $product_value->attribute_value }}">{{ $product_value->attribute_value }}</option>                                      @endif
                                                 @endforeach
                                             </select>
                                           </span>
                                           @endforeach
