...
/* events */
Route::get('/events', 'CommonController@view_events');
Route::get('/event/{event_slug}', 'CommonController@view_events_single');
Route::post('/vendor-register', ['as' => 'vendor-register','uses'=>'ProductController@vendor_register']);
Route::post('/confirm-vendor-register', ['as' => 'confirm-vendor-register','uses'=>'ProductController@confirm_vendor_register']);
Route::get('/event-success/{order_token}', 'PaymentController@vendor_register_success');
Route::post('/stripe-vendor-register', ['as'=>'stripe-vendor-register','uses'=>'StripeController@stripe_vendor_register']);

Route::post('/sponsor-register', ['as' => 'sponsor-register','uses'=>'ProductController@sponsor_register']);
/* events */
...
/* admin panel */
	...
	Route::get('/admin/vendor-registration', 'Admin\EventsController@vendor_registration');
	Route::get('/admin/vendor-registration-details/{reg_id}', 'Admin\EventsController@vendor_registration_details');
	Route::get('/admin/vendor-registration/{reg_id}', 'Admin\EventsController@vendor_registration_delete');
	
	Route::get('/admin/sponsor-registration', 'Admin\EventsController@sponsor_registration');
	Route::get('/admin/sponsor-registration-details/{reg_id}', 'Admin\EventsController@sponsor_registration_details');
	Route::get('/admin/sponsor-registration/{reg_id}', 'Admin\EventsController@vendor_registration_delete');
	/* events */
