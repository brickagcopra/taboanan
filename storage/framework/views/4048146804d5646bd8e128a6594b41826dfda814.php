                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       <?php if($demo_mode == 'on'): ?>
                           ...
                           <?php else: ?>
                       <form action="<?php echo e(route('admin.add-event')); ?>" method="post" id="setting_form" enctype="multipart/form-data">
...
<?php /**PATH C:\xampp\htdocs\brick2\resources\views/admin/add-event.blade.php ENDPATH**/ ?>