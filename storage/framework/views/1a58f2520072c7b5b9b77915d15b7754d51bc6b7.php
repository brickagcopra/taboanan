     ...
     <div class="col-lg-5 col-md-5 col-sm-4 mt-2 pt-1 mb-1">
      <nav class="pull-right" id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="<?php echo e(URL::to('/events')); ?>"> <?php echo e(Helper::translation(2905,$translate)); ?> </a></li>
...
</header><?php /**PATH C:\xampp\htdocs\brick2\resources\views/header.blade.php ENDPATH**/ ?>