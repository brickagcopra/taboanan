              ...
              <div class="form-row mt-4 mb-4">
               ...
               <div class="form-row mt-2 mb-2">
                           ...
                           <?php $no = 1; ?>
                                ...
                                <div class="custom-control custom-radio" <?php if($payment == 'paystack'): ?> <?php if($allsettings->site_currency_code != 'NGN'): ?> style="display:none;" <?php endif; ?> <?php endif; ?>>
                                    ...
                                    <label class="custom-control-label" for="opt1-<?php echo e($payment); ?>" <?php if($payment == 'paystack'): ?> <?php if($allsettings->site_currency_code != 'NGN'): ?> style="display:none;" <?php endif; ?> <?php endif; ?>><?php echo e($payment); ?> <?php if($payment == 'wallet'): ?> (<?php echo e($allsettings->site_currency_symbol); ?><?php echo e(Auth::user()->earnings); ?>) <?php endif; ?></label>
                                </div>
                                <?php $no++; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\brick2\resources\views/checkout.blade.php ENDPATH**/ ?>