...
class CouponController extends Controller
{
	...
	public function view_coupon()
    {
		...
		return view('my-coupon',[ 'couponData' => $couponData]);
    }
	...
	public function save_coupon(Request $request)
	{
		 ...
		 $rules = array(
				'coupon_code' => ['required',  Rule::unique('coupon') -> where(function($sql){ $sql->where('coupon_status','!=','');})],
        ...
        return redirect('/my-coupon')->with('success', 'Insert successfully.');
		}
  ...
  public function edit_coupon($coupon_id)
	...
	public function update_coupon(Request $request)
	{
        ...
        return redirect('/my-coupon')->with('success', 'Update successfully.');
		}
