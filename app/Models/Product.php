...
class Product extends Model
{
 ...
 public static function insertbrandData($data){
  ...
  {
    $value=DB::table('product_orders')->join('users','users.id','product_orders.product_user_id')->join('product','product.product_token','product_orders.product_token')->where('product_orders.product_user_id','=',$user_id)->orderBy('product_orders.ord_id', 'desc')->get(); 
    return $value;
  }
